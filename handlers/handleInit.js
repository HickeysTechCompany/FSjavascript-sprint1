...
async function handleInitCommand(options) {
  try {
    if (options.includes("--all")) {
      ...
      console.log(chalk.green.bold("Directory Structure Initialized\n"));
      ...
      console.log(chalk.green.bold("Config Files Initialized\n"));
      ...
      console.log(chalk.green.bold("Help Files Initialized\n"));
      ...
      console.log(chalk.green.bold("Function Structure Initialized\n"));
